/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c8ec2e558255216b72aaa3e185228f9b)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RESENT_API_SECRET" | "SERVICE_EMAIL" | "RECEIVING_EMAIL">> {}
}
declare module "../validation.toml" {
	const value: string;
